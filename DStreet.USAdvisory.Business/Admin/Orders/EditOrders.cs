...
{
    public class EditOrders : IOrder
    {
        //Private variables
        int _orderId;
        ...
        public EditOrders GetOrderByOrderId(int orderId,string userId)
        {
            return OrdersDAL.GetOrderByOrderId(orderId, userId);
        }
        ...
        /// </summary>
        /// 
        public void UpdateOrders(int OrderId)
        {
            this.OrderId = OrderId;
            OrdersDAL.UpdateOrders(this);
        }
