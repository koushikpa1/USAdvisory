...
namespace DStreet.USAdvisory.Business.Admin.Orders
{
    public class OrdersListing
    {
        ...
        //Commentary Listing
        public List<OrdersListing> GetAllOrders()
        {
            return OrdersDAL.GetAllOrders();
        }

        public List<OrdersListing> GetOrderFilterData(string filterData)
        {
            return OrdersDAL.GetOrderFilterData(filterData);
        }
