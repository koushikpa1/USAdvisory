...
{
    public class watchoutadd : IArticle
    {
        ...
        public watchoutadd(string articleTitle, string articleDesc, DateTime articleDateTime, bool IsPaid, string ticker)
        {
        ...
        public void AddWatchOutNews()
        {
            watchoutDAL.AddWatchOutNews(_articleTitle,_articleDateTime,_articleDesc,_isPaid,_ticker);
        }
