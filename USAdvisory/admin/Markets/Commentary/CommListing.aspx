<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="CommListing.aspx.cs" Inherits="admin_Markets_Commentary_CommListing" %>
<head>
...
<a href="../../Email/SendEmailListing.aspx">Send Email</a>
</div>
...
<div class="contentheader clearfix" >
        ...
        <H1 align="center">Market Commentary</H1>
        ...
        OnClick="lbGetAll_Click">Get All Commentary Articles</asp:LinkButton> 
        &nbsp;&nbsp;&nbsp;&nbsp;
        <a href="AddNewCommentary.aspx">Add New Commentary</a>
                        ...
                        <td>
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="ArticleTitle" HeaderText="ArticleTitle" 
                                        ...
                                        <ItemTemplate>
                                                             <a href="editmarketcommentary.aspx?mode=edit&id=<%#Eval("ArticleId")%>">Edit</a>
                                        </ItemTemplate>
                                        </asp:TemplateField>
        ...
        <asp:UpdateProgress ID="udProgress" runat="server" AssociatedUpdatePanelID="gvUpdatePanel"
                 ...
                 <asp:ObjectDataSource ID="ObjectDataSource1" 
                            runat="server" SelectMethod="GetAllMarketCommentaries" 
                            TypeName="DStreet.USAdvisory.Business.Admin.Markets.Commentary.commentarylisting">
