<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Newsviewslisting.aspx.cs" Inherits="admin_Markets_NewsViews_Newsviewslisting" %>
<head>
...
<div class="contentheader clearfix" >
        ...
        OnClick="lbGetAll_Click">Get All News Views Articles</asp:LinkButton> 
        &nbsp;&nbsp;&nbsp;&nbsp;
        <a href="AddNewsViews.aspx">Add New News & Views</a>
                        ...
                        <td>
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="ArticleTitle" HeaderText="ArticleTitle" 
                                        ...
                                        <ItemTemplate>
                                                             <a href="Editnewsviews.aspx?mode=edit&id=<%#Eval("ArticleId")%>">Edit</a>
                                        </ItemTemplate>
                                        </asp:TemplateField>
        ...
        <asp:UpdateProgress ID="udProgress" runat="server" AssociatedUpdatePanelID="gvUpdatePanel"
                 ...
                 <asp:ObjectDataSource ID="ObjectDataSource1" 
                            runat="server" SelectMethod="GetAllWatchOutNews" 
                            TypeName="DStreet.USAdvisory.Business.Admin.Markets.NewsViews.newsviewslisting">
