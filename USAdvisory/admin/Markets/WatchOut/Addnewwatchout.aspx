<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Addnewwatchout.aspx.cs" Inherits="admin_Markets_WatchOut_Addnewwatchout" %>
...
<h4>Add new Watch Out News !!! </h4></td></tr>
<TR><TD align=right  class="content" style="height: 13px;" >
    &nbsp;Watch Out Title :</TD><TD align=left  class="content" style="height: 13px"><asp:TextBox  
	SkinID=heading  id="txtheader" runat="Server" Width="358px"></asp:TextBox>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtheader"
            ...
            <TR><TD align=right  class="content" style="height: 13px;" >
    &nbsp;Watch Out Ticker :</TD><TD align=left  class="content" style="height: 13px"><asp:TextBox  
