<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Watchoutlisting.aspx.cs" Inherits="admin_Markets_WatchOut_Watchoutlisting" %>
...
<div class="contentheader clearfix" >
        ...
        OnClick="lbGetAll_Click">Get All Watch Outs</asp:LinkButton> 
        &nbsp;&nbsp;&nbsp;&nbsp;
        <a href="AddNewWatchOut.aspx">Add New Watch Out</a>
                        ...
                        <td>
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="ArticleTitle" HeaderText="ArticleTitle" 
                                        ...
                                        <ItemTemplate>
                                                             <a href="EditWatchOut.aspx?mode=edit&id=<%#Eval("ArticleId")%>">Edit</a>
                                        </ItemTemplate>
                                        </asp:TemplateField>
        ...
        <asp:UpdateProgress ID="udProgress" runat="server" AssociatedUpdatePanelID="gvUpdatePanel"
                 ...
                 <asp:ObjectDataSource ID="ObjectDataSource1" 
                            ...
                            TypeName="DStreet.USAdvisory.Business.Admin.Markets.WatchOut.watchoutlisting">
