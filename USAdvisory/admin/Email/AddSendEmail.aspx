<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddSendEmail.aspx.cs" Inherits="admin_Email_AddSendEmail" %>
...
<h4>Add new Send Email </h4></td></tr>
...
<TR><TD align=right  class="content" style="height: 13px;" >
    ...
    <asp:CheckBox id="isEmailSent" Checked = "True"
                    AutoPostBack="false"
                    TextAlign="Right"
                    runat="server"/>
