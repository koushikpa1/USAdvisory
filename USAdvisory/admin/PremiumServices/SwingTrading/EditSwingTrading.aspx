<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditSwingTrading.aspx.cs" Inherits="admin_PremiumServices_SwingTrading_EditSwingTrading" %>
...
<h4>Edit Swing Trading Stocks!!! </h4></td></tr>
<TR><TD align=right  class="content" style="height: 13px;" >
    &nbsp;Swing Trading Title :</TD><TD align=left  class="content" style="height: 13px"><asp:TextBox  
	SkinID=heading  id="txtheader" runat="Server" Width="358px"></asp:TextBox>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtheader"
            ...
            <TR><TD align=right  class="content" style="height: 13px;" >
    &nbsp;Swing Trading Ticker :</TD><TD align=left  class="content" style="height: 13px"><asp:TextBox  
