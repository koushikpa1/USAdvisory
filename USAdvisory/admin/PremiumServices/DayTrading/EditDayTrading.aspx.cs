...
public partial class admin_PremiumServices_DayTrading_EditDayTrading : System.Web.UI.Page
{
    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        ...
        premiumservicesedit _newsviewsEdit = new premiumservicesedit(txtheader.Text, fckcontent.Value, DateTime.Now, _isActive, _isPaid, txtTicker.Text,TradingType.DAYTRADING);
