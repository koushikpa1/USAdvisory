<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DayTradingListing.aspx.cs" Inherits="admin_PremiumServices_DayTrading_DayTradingListing" %>
...
<div class="contentheader clearfix" >
        ...
        <H1 align="center">Day Trading</H1>
        ...
        OnClick="lbGetAll_Click">Get All Day Trading Articles</asp:LinkButton> 
        &nbsp;&nbsp;&nbsp;&nbsp;
        <a href="AddNewDayTrading.aspx">Add New Day Trading</a>
                        ...
                        <td>
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="ArticleTitle" HeaderText="ArticleTitle" 
                                        ...
                                        <ItemTemplate>
                                                             <a href="EditDayTrading.aspx?mode=edit&id=<%#Eval("ArticleId")%>">Edit</a>
                                        </ItemTemplate>
                                        </asp:TemplateField>
