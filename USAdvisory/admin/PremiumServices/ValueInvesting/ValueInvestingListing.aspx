<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ValueInvestingListing.aspx.cs" Inherits="admin_PremiumServices_ValueInvesting_ValueInvestingListing" %>
...
<div class="contentheader clearfix" >
        ...
        OnClick="lbGetAll_Click">Get All Value Investing Articles</asp:LinkButton> 
        &nbsp;&nbsp;&nbsp;&nbsp;
        <a href="AddNewValueInvesting.aspx">Add New Value Investing</a>
                        ...
                        <td>
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="ArticleTitle" HeaderText="ArticleTitle" 
                                        ...
                                        <ItemTemplate>
                                                             <a href="EditValueInvesting.aspx?mode=edit&id=<%#Eval("ArticleId")%>">Edit</a>
                                        </ItemTemplate>
                                        </asp:TemplateField>
