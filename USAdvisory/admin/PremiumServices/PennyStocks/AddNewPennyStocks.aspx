<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddNewPennyStocks.aspx.cs" Inherits="admin_PremiumServices_PennyStocks_AddNewPennyStocks" %>
...
<h4>Add new Penny Stocks </h4></td></tr>
<TR><TD align=right  class="content" style="height: 13px;" >
    &nbsp;Penny Stocks Title :</TD><TD align=left  class="content" style="height: 13px"><asp:TextBox  
	SkinID=heading  id="txtheader" runat="Server" Width="358px"></asp:TextBox>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtheader"
            ErrorMessage="Required."></asp:RequiredFieldValidator></TD></TR>
             ...
             <TR><TD align=right  class="content" style="height: 13px;" >
    &nbsp;Penny Stocks Ticker :</TD><TD align=left  class="content" style="height: 13px"><asp:TextBox  
