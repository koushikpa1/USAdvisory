<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserListing.aspx.cs" Inherits="admin_Users_UserListing" %>
...
<div class="contentheader clearfix" >
        ...
        OnClick="lbGetAll_Click">Get All Users</asp:LinkButton> 
        &nbsp;&nbsp;&nbsp;&nbsp;
        <a href="AddUsers.aspx">Add New User</a>
                        ...
                        <td>
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="FirstName" HeaderText="FirstName" 
                                        ...
                                        <ItemTemplate>
                                                             <a href="EditUsers.aspx?mode=edit&id=<%#Eval("UserId")%>">Edit</a>
                                        </ItemTemplate>
                                        </asp:TemplateField>

                                    <asp:BoundField DataField="RegistrationDate" HeaderText="RegistrationDate" 
                                        SortExpression="RegistrationDate" dataformatstring ="{0:dd-MM-yyyy}"/>
                                        
                                           <asp:BoundField DataField="IsPaidSubscriber" HeaderText="IsPaidSubscriber" 
                                        SortExpression="IsPaidSubscriber" />
        ...
        <asp:UpdateProgress ID="udProgress" runat="server" AssociatedUpdatePanelID="gvUpdatePanel"
                 ...
                 <asp:ObjectDataSource ID="ObjectDataSource1" 
                            ...
                            TypeName="DStreet.USAdvisory.Business.Admin.Users.UserListing">
