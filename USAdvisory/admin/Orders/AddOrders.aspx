<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddOrders.aspx.cs" Inherits="admin_Orders_AddOrders" %>
...
<script type="text/javascript">
    ...
    tabdropdown.init("glowmenu", "auto")
     ...
     <table  width="99%">
     <tr><td align="center" class="header" colspan=2>Order Management</td></tr>
    <tr>
