<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Addnewportfolioitem.aspx.cs" Inherits="admin_Portfolio_Addnewportfolioitem" %>
...
<h4>Add new stock to portfolio </h4></td></tr>
<TR><TD align=right  class="content" style="height: 13px;" >
    &nbsp;Portfolio :</TD><TD align=left  class="content" style="height: 13px"><asp:TextBox  
	...
	SkinID=heading  id="CompanyName" runat="Server" Width="358px"></asp:TextBox>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="CompanyName"
            ErrorMessage="Required."></asp:RequiredFieldValidator></TD></TR>
	...
	SkinID=heading  id="txtTicker" runat="Server" Width="358px"></asp:TextBox>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtTicker"
            ErrorMessage="Required."></asp:RequiredFieldValidator></TD></TR>
	...
	SkinID=heading  id="txtEntryPrice" runat="Server" Width="358px"></asp:TextBox>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtEntryPrice"
            ErrorMessage="Required."></asp:RequiredFieldValidator></TD></TR>
	...
	SkinID=heading  id="txtExitPrice" runat="Server" Width="358px"></asp:TextBox>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtExitPrice"
            ErrorMessage="Required."></asp:RequiredFieldValidator></TD></TR>
			
			<TR><TD align=right  class="content" style="height: 13px;" >
    &nbsp;Portfolio Stop Loss :</TD><TD align=left  class="content" style="height: 13px"><asp:TextBox  
	SkinID=heading  id="txtStopLoss" runat="Server" Width="358px"></asp:TextBox>
	
        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtStopLoss"
            ErrorMessage="Required."></asp:RequiredFieldValidator></TD></TR>
	...
	SkinID=heading  id="txtEntryDate" runat="Server" Width="358px"></asp:TextBox>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtEntryDate"
            ErrorMessage="Required."></asp:RequiredFieldValidator></TD></TR>
	...
	SkinID=heading  id="txtCallStatus" value ="O" runat="Server" Width="358px"></asp:TextBox>
     ...
     <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txtCallStatus"
            ErrorMessage="Required."></asp:RequiredFieldValidator> O of Open and C for Closed</TD></TR>
