<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Addnewsviews.aspx.cs" Inherits="admin_Markets_NewsViews_Addnewsviews" %>
...
<h4>Add new News & Views </h4></td></tr>
<TR><TD align=right  class="content" style="height: 13px;" >
    &nbsp;News Views Title :</TD><TD align=left  class="content" style="height: 13px"><asp:TextBox  
	SkinID=heading  id="txtheader" runat="Server" Width="358px"></asp:TextBox>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtheader"
            ErrorMessage="Required."></asp:RequiredFieldValidator></TD></TR>
             ...
             <TR><TD align=right  class="content" style="height: 13px;" >
    &nbsp;News Views Ticker :</TD><TD align=left  class="content" style="height: 13px"><asp:TextBox  
