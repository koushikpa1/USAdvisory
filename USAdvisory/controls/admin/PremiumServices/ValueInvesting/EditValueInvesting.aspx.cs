...
public partial class admin_PremiumServices_ValueInvesting_EditValueInvesting : System.Web.UI.Page
{
    /// <summary>
    /// 
    /// </summary>
    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        ...
        premiumservicesedit _newsviewsEdit = new premiumservicesedit(txtheader.Text, fckcontent.Value, DateTime.Now, _isActive, _isPaid, txtTicker.Text, TradingType.VALUEINVESTING);
