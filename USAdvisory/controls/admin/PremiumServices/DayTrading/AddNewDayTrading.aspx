<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddNewDayTrading.aspx.cs" Inherits="admin_PremiumServices_DayTrading_AddNewDayTrading" %>
...
<a href="../PennyStocks/PennyStocksListing.aspx">Value Investing</a>
</div>
...
<h4>Add new Day Trading </h4></td></tr>
<TR><TD align=right  class="content" style="height: 13px;" >
    &nbsp;Day Trading Title :</TD><TD align=left  class="content" style="height: 13px"><asp:TextBox  
	SkinID=heading  id="txtheader" runat="Server" Width="358px"></asp:TextBox>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtheader"
            ErrorMessage="Required."></asp:RequiredFieldValidator></TD></TR>
             ...
             <TR><TD align=right  class="content" style="height: 13px;" >
    &nbsp;Day Trading Ticker :</TD><TD align=left  class="content" style="height: 13px"><asp:TextBox  
