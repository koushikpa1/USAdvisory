<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PennyStockListing.aspx.cs" Inherits="admin_PremiumServices_PennyStocks_PennyStockListing" %>
...
<div class="contentheader clearfix" >
        ...
        <H1 align="center">Penny Stocks</H1>
        ...
        OnClick="lbGetAll_Click">Get All Penny Stock Articles</asp:LinkButton> 
        &nbsp;&nbsp;&nbsp;&nbsp;
        <a href="AddNewPennyStocks.aspx">Add New Penny Stock</a>
                        ...
                        <td>
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="ArticleTitle" HeaderText="ArticleTitle" 
                                        ...
                                        <ItemTemplate>
                                                             <a href="EditPennyStocks.aspx?mode=edit&id=<%#Eval("ArticleId")%>">Edit</a>
                                        </ItemTemplate>
                                        </asp:TemplateField>
