        ...
        <div class="main-block">
            <div class="content-block">
                                    ...
                                    <asp:TabPanel ID="TabPanel1" runat="server" HeaderText="Open Porfolio">
                                        <ContentTemplate>
                                            <asp:GridView ID="GridView_VirtualPortfolioOpen" runat="server" CellPadding="4" ForeColor="#333333"
                                                ...
                                                OnPageIndexChanging="GridView_VirtualPortfolioOpen_PageIndexChanging">
                                                <Columns>
                                            ...
                                            <div><asp:Label runat="server">No of Records Per Page</asp:Label>
             ...
             <asp:TabPanel ID="TabPanel2" runat="server" HeaderText="Closed Portfilio">
                <ContentTemplate>
                     <asp:GridView ID="GridView_VirtualPortfolioClosed" runat="server" 
                         CellPadding="4" ForeColor="#333333" 
                        GridLines="None" EnableModelValidation="True" AllowPaging="True" 
                        AutoGenerateColumns="False" 
                         onpageindexchanging="GridView_VirtualPortfolioClosed_PageIndexChanging">
                        
            
                               <Columns>
                                       <asp:BoundField DataField="StockTicker" HeaderText="Ticker" 
                                            SortExpression="Ticker" >
                                           <HeaderStyle Width="100px" />
                                           <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                          <asp:BoundField DataField="BuyOrSell" HeaderText="BuyOrSell" 
                                            SortExpression="BuyOrSell" >
                                              <HeaderStyle Width="100px" />
                                              <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                            <asp:BoundField DataField="Qty" HeaderText="Qty" SortExpression="Qty" >
                                           ...
                                           <asp:BoundField DataField="EntryPrice" HeaderText="EntryPrice" 
                                            SortExpression="EntryPrice" >
                                               <HeaderStyle Width="100px" />
                                               <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                            <asp:BoundField DataField="ExitPrice" HeaderText="ExitPrice" 
                                            SortExpression="ExitPrice" >
                                                <HeaderStyle Width="100px" />
                                                <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                            <asp:BoundField DataField="StopLoss" HeaderText="StopLoss" 
                                            SortExpression="StopLoss" >
                   ...
                   <div><asp:Label ID="Label1" runat="server">No of Records Per Page</asp:Label>
